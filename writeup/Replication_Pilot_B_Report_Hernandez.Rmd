...
exp2.aov <- anovaBF(correct ~ Result_given + Condition + Condition*Result_given,  data = exp2_binary_cum_result_by_id,
whichRandom = "Result_given")
exp2.aov
```
