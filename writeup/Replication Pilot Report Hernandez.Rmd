...
pilot <- read_xlsx('C:/Users/crazy/OneDrive/Desktop/pilditch2019/Pilot_data_revised.xlsx') #working on code to pull from github, however have been getting errors when the path is a github url. 
...
# trying to get this code to work  summarise(proportion_yes = count(exp2_decision_long_mod$value, value))
...
exp2_proportions
 ...
 # examine cross tabs - sanity check
