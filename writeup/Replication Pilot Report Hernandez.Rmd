...
pilot <- read.csv('https://github.com/psych251/pilditch2019/blob/master/Pilot_study.csv', header = TRUE)

#### Data exclusion / filtering

#pseudocode filter out all non-important variables, all but reponses to scenario and confidence
